...
if (curIndex mod 7) == 2   //just some sample stuff to change the variable height by lineitem
    {
      ...
      draw_text(curX+100,curY+5,string_hash_to_newline(curLineSt));
    }
    else draw_text(curX+4,curY+2,string_hash_to_newline(curLineSt));

draw_set_color(c_orange);
draw_text(curX+275,curY+5, string_hash_to_newline("$4.50"));    
